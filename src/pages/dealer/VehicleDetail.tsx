        ...
        <div className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-border bg-card p-5 shadow-soft">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-2xl bg-[#FFC700] hover:bg-[#FFD633] px-4 py-2.5 text-xs font-black text-[#0D0E12] transition-all cursor-pointer shadow-md"
            >
